...
namespace glm
{
	...
	///
	/// @param direction Desired forward direction_A. Needs to be normalized.
	...
	///
	/// @param direction Desired forward direction_A onto which the -z-axis gets mapped. Needs to be normalized.
	/// @param up Up vector, how the camera is oriented. Typically (0, 1, 0).
	template<typename T, qualifier Q>
